public class UnionFind6 implements UF {
    ...
    // 用数组存储以当前节点为根的树的级别 (非层数), rank 的值表示的是在路径压缩之后, 离根节点的距离
    private int[] ranks;
    ...
    // 查找索引为 i 的节点所对应的集合编号 (即当前节点所在的树的根节点的值 / 集合编号)
    private int find(int i) {
        ...
        if (parents[i] != i) {
            ...
            // 递归调用
            // 查找当前节点的父节点 (索引为 parents[i]) 所对应的集合编号 (即根节点的值 / 集合编号), 并将当前节点 (索引为 i) 的父节点指向根节点
