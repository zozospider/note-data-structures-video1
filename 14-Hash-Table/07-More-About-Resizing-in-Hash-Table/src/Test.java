...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        // 随机生成 50 万个单词, 每个单词 2 个小写字母 (不同的测试参数对结果会有影响)
        int count = 500_000;
        int charNumber = 2;
        ...
        // 时间复杂度:
        // TODO
        Map<String, Integer> hashTableMap = new HashTableMap<>();
        long hashTableTime = testMap(hashTableMap, words);
        System.out.println("Total different words: " + hashTableMap.getSize());
        System.out.println("HashTableMap time: " + hashTableTime + "ms");
